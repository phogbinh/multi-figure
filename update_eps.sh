...
cp ${SIMULATION_DIR}experiments_swapping/execution_time.eps ./swapping_execution_time.eps
cp ${SIMULATION_DIR}experiments_swapping/punctured_costs.eps ./swapping_punctured_costs.eps
...
cp ${SIMULATION_DIR}experiments_busy/associated_urllc_users_nums.eps ./busy_associated_urllc_users_nums.eps
cp ${SIMULATION_DIR}experiments_casual/total_average_rates.eps ./casual_total_average_rates.eps
