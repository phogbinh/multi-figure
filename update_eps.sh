...
cp ${SIMULATION_DIR}experiments_feasibility/associated_urllc_users_nums.eps ./feasibility_associated_urllc_users_nums.eps
cp ${SIMULATION_DIR}experiments_optimality/total_average_rates.eps ./optimality_total_average_rates.eps
cp ${SIMULATION_DIR}experiments_optimality/fairness.eps ./optimality_fairness.eps
